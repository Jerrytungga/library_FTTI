...
?>
    ...
    <div class=" ml-4 mt-3 form-inline">
              <input type="date" name="date_awal" class="form-control col-2 rounded-10 shadow mr-2" required>
              <input type="date" name="date_akhir" class="form-control col-2 rounded-10 shadow mr-2" required>
